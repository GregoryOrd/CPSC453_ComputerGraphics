...
Note about changing scenes:
Changing scenes appear to be very slow. About 15-25 seconds on my machine.
This was the performance on my machine prior to any of my changes to the boilerplate.
The program will appear to freeze for this time while the calculations are happening to change scenes.
After making my changes, the delays when switching scenes seem to be even larger.
